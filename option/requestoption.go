...
// RequestOption is an option for the requests made by the davescloudserver API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/davescloudserver2026/https-github.com-amitshekhariitbhu-Android-Debug-Database#readme-requestoptions
