...
// interacting with the davescloudserver API. You should not instantiate this
...
// DAVESCLOUDSERVER_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("DAVESCLOUDSERVER_BASE_URL"); ok {
...
// environment (PETSTORE_API_KEY, DAVESCLOUDSERVER_BASE_URL). The option passed in
